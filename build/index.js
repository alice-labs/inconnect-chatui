...
var ImageMessage = function (_a) {
    ...
    return (React.createElement("div", __assign({ style: __assign({}, style), className: "" + (userType === 'user' ? userContainer$1 : adminContainer$1) + className }, rest),
        !!text && (React.createElement("div", { className: globalTextBlock$1 + " " + (userType === 'user' ? textBlockUser$1 : textBlockAdmin$1) }, text)),
...
var QuickReplyMessage = function (_a) {
    var style = _a.style, className = _a.className, text = _a.text, buttonData = _a.buttonData, msgTime = _a.msgTime, repliedBy = _a.repliedBy, showRepliedBy = _a.showRepliedBy, rest = __rest(_a, ["style", "className", "text", "buttonData", "msgTime", "repliedBy", "showRepliedBy"]);
    return (React.createElement("div", __assign({ style: __assign({}, style), className: "" + adminContainer$3 + className }, rest),
        React.createElement("div", { className: globalTextBlock$3 + " " + textBlockAdmin$3 }, text),
