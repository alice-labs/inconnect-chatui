...
var TextMessage = function (_a) {
    ...
    return (React.createElement("div", __assign({ style: __assign({}, style), className: "" + (type === 'user' ? userContainer : adminContainer) + className }, rest),
        React.createElement("div", { className: globalTextBlock + " " + (type === 'user' ? textBlockUser : textBlockAdmin) }, text),
        (showRepliedBy || !!msgTime) && (React.createElement("p", { className: "" + msgTimeClass },
            !!msgTime && React.createElement(React.Fragment, null,
                msgTime,
                " \u00A0 "),
            ' ',
            type === 'admin' && showRepliedBy && React.createElement(React.Fragment, null,
                "\u2022 \u00A0 ",
                repliedBy)))));
};
...
exports.ChatContainer = TextMessage;
