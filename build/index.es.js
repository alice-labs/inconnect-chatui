import React__default, { createElement, Fragment, useState } from 'react';
...
var TextMessage = function (_a) {
    ...
    return (createElement("div", __assign({ style: __assign({}, style), className: "" + (consumer === 'user'
        ...
        createElement(AvatarContainer, { avatar: avatar, userType: userType, consumer: consumer },
        ...
        showInfo && (showRepliedBy || !!msgTime) && (createElement("p", { className: "" + msgTimeClass, style: avatar
                ? consumer === 'user'
                    ? userType === 'user'
                        ? { marginRight: '30px' }
                        : { marginLeft: '30px' }
...
var NoteMessage = function (_a) {
    ...
    return (createElement("div", null,
        createElement("div", __assign({ style: __assign({}, style), className: noteContainer + " " + className }, rest),
...
var ImageMessage = function (_a) {
    ...
    return (createElement("div", __assign({ style: __assign({}, style), className: "" + (consumer === 'user'
        ...
        !!text && (createElement(AvatarContainer, { avatar: avatar, userType: userType, consumer: consumer },
            createElement("div", { className: globalTextBlock$1 + " " + (consumer === 'user'
                    ? userType === 'user'
                        ? textBlockAdmin$1
                        : textBlockUser$1
                    : userType === 'user'
        ...
        createElement(AvatarContainer, { avatar: avatar, userType: userType, consumer: consumer },
            createElement("div", { className: "" + flexImageContainer }, !!images &&
                ...
                images.map(function (imageItem, i) { return (createElement("div", { className: "" + flexImageContainerDiv, key: i, onClick: function () {
                    ...
                    createElement("img", { className: "" + flexImageContainerElement, src: imageItem, key: i, width: '250px' }))); }))),
        (showRepliedBy || !!msgTime) && (createElement("p", { className: "" + msgTimeClass$1, style: avatar
                ? consumer === 'user'
                    ? userType === 'user'
                        ? { marginRight: '30px' }
                        : { marginLeft: '30px' }
...
var ButtonMessage = function (_a) {
    ...
    return (createElement("div", __assign({ style: __assign({}, style), className: "" + (consumer === 'user' ? userContainer$2 : adminContainer$2) + className }, rest),
        ...
        !!buttonData && buttonData.length > 0 && (createElement("div", { className: globalTextBlock$2 + " " + buttonBlockAdmin, style: avatar
            ...
            return methodType === 'url' ? (createElement("button", __assign({ disabled: isDisabled, onClick: function () { return window.open(url, '_blank'); }, className: btnElement + " " + aLinkWidthFix + " " + className, style: style, key: i }, rest), title)) : (createElement("button", __assign({ disabled: isDisabled, className: btnElement + " " + className, style: style, onClick: action, key: i }, rest), title));
        }))),
        (showRepliedBy || !!msgTime) && (createElement("p", { className: "" + msgTimeClass$2, style: avatar
                ? consumer === 'user'
                    ? { marginLeft: '30px' }
                    : { marginRight: '30px' }
                : {} },
...
var QuickReplyMessage = function (_a) {
    ...
    return (createElement("div", __assign({ style: __assign({}, style), className: "" + (consumer === 'user' ? userContainer$3 : adminContainer$3) + className }, rest),
        ...
        (showRepliedBy || !!msgTime) && (createElement("p", { className: "" + msgTimeClass$3, style: avatar
                ? consumer === 'user'
                    ? { marginLeft: '30px' }
                    : { marginRight: '30px' }
                : {} },
...
var FeedPost = function (_a) {
    var style = _a.style, className = _a.className, note = _a.note, msgTime = _a.msgTime, takenBy = _a.takenBy, postAvatar = _a.postAvatar, postName = _a.postName, postTime = _a.postTime, content = _a.content, contentType = _a.contentType, replyContent = _a.replyContent, pageLink = _a.pageLink, commentData = _a.commentData, contentItem = _a.contentItem, commentBg = _a.commentBg, _b = _a.showCommentAction, showCommentAction = _b === void 0 ? false : _b, _c = _a.showHideCommentAction, showHideCommentAction = _c === void 0 ? true : _c, _d = _a.showDeleteCommentAction, showDeleteCommentAction = _d === void 0 ? true : _d, _e = _a.showAction, showAction = _e === void 0 ? false : _e, _f = _a.showEditReplyAction, showEditReplyAction = _f === void 0 ? true : _f, _g = _a.showDeleteReplyAction, showDeleteReplyAction = _g === void 0 ? true : _g, _h = _a.showHideReplyAction, showHideReplyAction = _h === void 0 ? true : _h, closeOnActionClick = _a.closeOnActionClick, moreButtonHeightWidth = _a.moreButtonHeightWidth, editInputStyle = _a.editInputStyle, editInputClass = _a.editInputClass, status = _a.status, handleDelete = _a.handleDelete, handleEdit = _a.handleEdit, handleHide = _a.handleHide, handleCommentDelete = _a.handleCommentDelete, handleCommentHide = _a.handleCommentHide, handleReplyCancel = _a.handleReplyCancel, handleReplyEdit = _a.handleReplyEdit, rest = __rest(_a, ["style", "className", "note", "msgTime", "takenBy", "postAvatar", "postName", "postTime", "content", "contentType", "replyContent", "pageLink", "commentData", "contentItem", "commentBg", "showCommentAction", "showHideCommentAction", "showDeleteCommentAction", "showAction", "showEditReplyAction", "showDeleteReplyAction", "showHideReplyAction", "closeOnActionClick", "moreButtonHeightWidth", "editInputStyle", "editInputClass", "status", "handleDelete", "handleEdit", "handleHide", "handleCommentDelete", "handleCommentHide", "handleReplyCancel", "handleReplyEdit"]);
    ...
    var getContents = function () {
        switch (contentType) {
            ...
            case 'image':
                return (createElement(Fragment, null,
                    createElement("p", null, content),
                    createElement("div", { className: "" + flexWrapContainer }, !!contentItem &&
                        contentItem.map(function (elem, index) { return (createElement("img", { src: elem, className: "" + imageHolder, alt: index + '', key: index, width: 'fit-content' })); }))));
            default:
    ...
    var getReplyContent = function (reply) {
        switch (reply.contentType) {
            case 'text':
                return (createElement("p", { className: "" + replyContentText, style: reply.status === 'remove'
            ...
            case 'image':
                return (createElement(Fragment, null,
                    createElement("p", { className: "" + replyContentText, style: reply.status === 'remove'
                            ? { textDecoration: 'line-through' }
                            : {} }, reply.content),
                    createElement("img", { className: "" + replyContentImage, src: reply.image, alt: 'image-note' })));
            default:
                return 'No contentType matched';
        }
    };
    var _j = useState(null), showPopover = _j[0], setShowPopover = _j[1];
    var _k = useState(null), editReply = _k[0], setEditReply = _k[1];
    var _l = useState(''), editText = _l[0], setEditText = _l[1];
    return (createElement("div", __assign({ style: __assign({}, style), className: feedContainer + " " + className }, rest),
        createElement("div", { className: "" + feedPostContainer },
            createElement("div", { className: "" + postInfoContainer },
                ...
                createElement("div", { style: {
                    ...
                    showCommentAction &&
                        ...
                        showPopover === commentData.id + '-comment' && (createElement("div", { className: "" + moreButtonContainer },
                            showHideCommentAction && (createElement("div", { onClick: function () {
                            ...
                            showDeleteCommentAction && (createElement("div", { onClick: function () {
                ...
                createElement("div", { style: {
                    ...
                    createElement("div", { style: {
                        ...
                        createElement("div", { style: reply.contentType === 'note'
                            ...
                            !!editReply && editReply.id === reply.id ? (createElement("div", null,
                                createElement("textarea", { rows: 3, placeholder: 'Type here...', value: editText, onChange: function (e) {
                    ...
                    showAction &&
                        ...
                        createElement("div", { className: "" + moreButton, style: {
                            ...
                            createElement("svg", { "data-icon": 'more', viewBox: '0 0 16 16', style: { fill: 'rgb(102, 120, 138)' } },
                                createElement("path", { d: 'M2 6.03a2 2 0 100 4 2 2 0 100-4zM14 6.03a2 2 0 100 4 2 2 0 100-4zM8 6.03a2 2 0 100 4 2 2 0 100-4z', fillRule: 'evenodd' }))),
                        showPopover === reply.id && (createElement("div", { className: "" + moreButtonContainer },
                            reply.source !== 'customer' && showEditReplyAction && (createElement("div", { onClick: function () {
                                    var _a, _b;
                                    if (!!handleEdit) {
                                        handleEdit(reply);
                                        setEditReply(reply);
                            ...
                            showHideReplyAction && (createElement("div", { onClick: function () {
                                    if (!!handleHide) {
                                        handleHide(reply);
                                        if (closeOnActionClick) {
                                            setShowPopover(null);
                            ...
                            showDeleteReplyAction && (createElement("div", { onClick: function () {
                                    if (!!handleDelete) {
                                        handleDelete(reply);
                                        if (closeOnActionClick) {
                                            setShowPopover(null);
            ...
            return (createElement("div", { className: "" + galleryItemContainer, key: index },
                gallery.image &&
                    createElement("div", { className: galleryItemCover + " " + galleryItemClassName },
                        createElement("img", { src: gallery.image, style: {
                                overflow: 'hidden',
                ...
                createElement("div", { className: "" + galleryItemButtons, style: { overflow: 'hidden' } }, !!gallery.buttons &&
                    gallery.buttons.map(function (galleryButton, index) {
                        return galleryButton.methodType === 'url' &&
                            !!!galleryButton.isDisabled ? (createElement("button", { key: index, className: galleryItemButtonElement + " " + galleryButton.className, style: __assign({}, galleryButton.style), onClick: function () { return window.open(galleryButton.url, '_blank'); } }, galleryButton.title)) : (createElement("button", { key: index, className: galleryItemButtonElement + " " + galleryButton.className, style: galleryButton.style, onClick: galleryButton.action, disabled: galleryButton.isDisabled }, galleryButton.title));
                    }))));
        })),
...
export { ButtonMessage, FeedPost, GalleryMessage, ImageMessage, NoteMessage, QuickReplyMessage, TextMessage };
