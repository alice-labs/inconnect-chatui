...
var FeedPost = function (_a) {
    ...
    var _b = useState(null), showPopover = _b[0], setShowPopover = _b[1];
    var _c = useState(null), editReply = _c[0], setEditReply = _c[1];
    var _d = useState(''), editText = _d[0], setEditText = _d[1];
