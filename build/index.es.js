...
var TextMessage = function (_a) {
    ...
    return (createElement("div", __assign({ style: __assign({}, style), className: "" + (consumer === 'user'
        ...
        showInfo && (showRepliedBy || !!msgTime) && (createElement("p", { className: "" + msgTimeClass },
    ...
    return (createElement("div", __assign({ style: __assign({}, style), className: feedContainer + " " + className }, rest),
        createElement("div", { className: "" + feedPostContainer },
            createElement("div", { className: "" + postInfoContainer },
                createElement("img", { className: "" + avatarStyle, style: { background: "url('" + postAvatar + "')" } }),
                createElement("div", { style: { marginLeft: 10, flex: 10 } },
                    createElement("p", { className: "" + postNameStyle }, postName),
            ...
            replyContent.map(function (reply, i) { return (createElement("div", { className: "" + replyInfoContainer, key: i },
                createElement("img", { className: "" + avatarSmallStyle, style: { background: "url('" + reply.avatar + "')" } }),
                createElement("div", { style: { marginLeft: 10, flex: 10 } },
                    createElement("p", { className: "" + postNameStyle }, reply.name),
